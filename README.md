...
WAR Overlay Type: `cas-management-overlay`

# Versions
   
- CAS Management `6.3.10`
- CAS Server `6.3.7.4`
...
```bash
java -Xdebug -Xrunjdwp:transport=dt_socket,address=5000,server=y,suspend=y -jar build/libs/cas-management.war
```
